...
# define REAL_RADIX            18LL //15
# define REAL_FACTOR           (1LL<<18LL) //32768 //(32.0 * 1024.0)
...
# define REAL_TO_SHORT(x)      (long) ((x) >> REAL_RADIX)
...
#define VERBOSE  0//(NOQUIET && fr->p.verbose)
#define VERBOSE2 0//(NOQUIET && fr->p.verbose > 1)
#define VERBOSE3 0//(NOQUIET && fr->p.verbose > 2)
#define VERBOSE4 0//(NOQUIET && fr->p.verbose > 3)
